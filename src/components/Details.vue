<template>
  <div v-bind:class="[details ? 'showDetails' : 'hideDetails']">
    <div class="structure">
      <div class="panel" v-bind:class="[details ? 'showPanel' : 'hidePanel']">
        <div class="panel__close" v-on:click="hideDetails">
          <img src="../assets/close__light.svg" class="icon" />
        </div>
